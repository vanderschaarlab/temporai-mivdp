"""A docs building code that must be ran when building TemporAI-MIVDP docs.
...
REPO_URL_ROOT = "https://github.com/vanderschaarlab/temporai-mivdp/"
...
# Fix images:
convert = {
    r"\"docs/assets/(.*?\..*?)\"": r"'https://raw.githubusercontent.com/vanderschaarlab/temporai-mivdp/main/docs/assets/\1'",
    r"\[docs/assets/(.*?\..*?)\]": r"[https://raw.githubusercontent.com/vanderschaarlab/temporai-mivdp/main/docs/assets/\1]",
}
