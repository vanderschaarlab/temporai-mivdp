...
Welcome to `temporai-mivdp` contributor's guide.
...
If you experience bugs or general issues with `temporai-mivdp`, please have a look
...
You can help improve `temporai-mivdp` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`temporai-mivdp` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `temporai-mivdp`'s files. While this mechanism can
...
```
conda create -n temporai-mivdp python=3 six virtualenv pytest pytest-cov
conda activate temporai-mivdp
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/temporai-mivdp.git
   cd temporai-mivdp
   ```
...
5. Install [pre-commit]:
   ...
   `temporai-mivdp` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/vanderschaarlab/temporai-mivdp
[issue tracker]: https://github.com/vanderschaarlab/temporai-mivdp/issues
